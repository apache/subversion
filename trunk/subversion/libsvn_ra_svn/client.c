...
#define GET_LOCKS_STR \
        "\x67\x65\x74\x2d\x6c\x6f\x63\x6b\x73"
        /* "get-locks" */

#define GET_LOCK_STR \
        "\x67\x65\x74\x2d\x6c\x6f\x63\x6b"
        /* "get-lock" */
                                    ...
                                    apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(b->conn, pool, SET_PATH_STR, "crb(?c)", path, rev,
                                     ...
                                     apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(b->conn, pool, LINK_PATH_STR, "ccrb(?c)",
                               ...
                               apr_pool_t *pool)
{
  ...
  apr_err = apr_uri_parse (pool, url_native, uri);
...
{
  static const char *schemes[] = { SVN_STR, NULL };
                                    ...
                                    apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(conn, pool, REPARENT_STR, "c", url));
                                  ...
                                  apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_tuple(conn, pool, "w(c(!", COMMIT_STR, log_msg));
  if (lock_tokens)
    {
                                   ...
                                   apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_tuple(conn, pool, "w(c(?r)bb(!", GET_DIR_STR, path,
                                ...
                                void *diff_baton, apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(conn, pool, DIFF_STR, "(?r)cbbcb", rev,
                                ...
                                svn_dirent_t **dirent, apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(conn, pool, STAT_STR, "c(?r)", path, rev));
                                         ...
                                         void *handler_baton, apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(sess_baton->conn, pool, GET_FILE_REVS_STR,
  ...
  for (hi = apr_hash_first(pool, path_tokens); hi; hi = apr_hash_next(hi))
    {
      ...
      SVN_ERR(svn_ra_svn_write_cmd(conn, iterpool, UNLOCK_STR, "c(?c)b",
                                    ...
                                    apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(conn, pool, GET_LOCK_STR, "c", path));
                                     ...
                                     apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_ra_svn_write_cmd(conn, pool, GET_LOCKS_STR, "c", path));
