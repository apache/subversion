...
echo ""
echo "Or, if configure has trouble finding the correct version of Berkeley DB"
echo "because you've installed the latest db in /usr/local/ but GCC is"
echo "mixing the old system library with your new header, you might try"
echo "this command line:"
echo ""
echo "LDFLAGS=-L/usr/local/lib ./configure --with-maintainer-mode --disable-shared"
echo ""
