...
/* Indicate that the contents of the node ID in FS are expected to be
   stable now, as part of the Berkeley DB transaction DB_TXN.  This
   suggests to the deltification code that it could be effective to
   represent other nodes' contents as deltas against this node's
   contents.  This does not change the contents of the node.
