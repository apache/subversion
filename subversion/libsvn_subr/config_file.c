  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "###   ignore-ssl-unknown-ca    Allow untrusted server certificates\n"
        "###   ignore-ssl-invalid-date  Allow expired/postdated certificates\n"
        "###   ignore-ssl-host-mismatch Allow certificates for other servers\n"
        "###\n"
