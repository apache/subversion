...
svn_config_ensure (apr_pool_t *pool)
{
  ...
  if (kind == svn_node_none)
	...
	"###   ignore-ssl-unknown-ca    Accept untrusted server certificates\n"
	"###   ignore-ssl-invalid-date  Accept expired/postdated certificates\n"
	"###   ignore-ssl-host-mismatch Accept certificates for other servers\n"
        "###\n"
