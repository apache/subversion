...
#define SVN_WC__ENTRY_ATTR_LOCK_CRT_DATE "lock-creation-date"
#define SVN_WC__ENTRY_ATTR_LOCK_EXP_DATE "lock-expiration-date"
...
/* ### Do we want to waste 5 flags on the lock, when the information will be
   modified all or none? */
#define SVN_WC__ENTRY_MODIFY_LOCK          0x00200000
