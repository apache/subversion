...
/* Delete node revision ID from FS's `nodes' table, allocating from
   POOL.  WARNING: This does not check that the node revision is
   mutable!  Callers should do that check themselves.  */
