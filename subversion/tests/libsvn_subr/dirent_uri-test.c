...
test_uri_condense_targets(apr_pool_t *pool)
{
  ...
  struct {
    ...
    { { "/dir", "/dir/file", NULL },         "/dir",     { "", "file" } },
    { { "/dir", "http://srv", NULL },        "" ,        { "/dir", "http://srv" }},
    { { "/dir", "/Dir/file", NULL },         "/",        { "dir", "Dir/file" } },
    { { "/dir1", "/dir2", NULL },            "/",        { "dir1", "dir2" } },
    { { "/dir", "/dir/file", NULL },         "/dir",     { "", "file" } },
    { { "/dir1", "/dir2", NULL },            "/",        { "dir1", "dir2" } },
    { { "/dir1", "/dir2/q", NULL },           "/",       { "dir1", "dir2/q" } },
  ...
  for (i = 0; i < COUNT_OF(tests); i++)
    {
      ...
      if (tests[i].common != NULL && strcmp(common, tests[i].common))
        return svn_error_createf(SVN_ERR_TEST_FAILED, NULL,
                                 "svn_uri_condense_targets(%s, %s, %s) "
                                 "returned common \"%s\". expected \"%s\"",
                                 tests[i].paths[0], tests[i].paths[1],
                                 tests[i].paths[2], common, tests[i].common);
