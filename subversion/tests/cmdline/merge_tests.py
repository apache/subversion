...
def merge_to_path_with_switched_children(sbox):
  ...
  expected_disk = wc.State('', {
    ''      : Item(props={SVN_PROP_MERGE_INFO : '/A/D/H:8*'}),
    'psi'   : Item("This is the file 'psi'.\n",
                   props={SVN_PROP_MERGE_INFO : '/A/D/H/psi:8'}),
    'omega' : Item("New content",
                   props={SVN_PROP_MERGE_INFO : '/A/D/H/omega:8'}),
    'chi'   : Item("This is the file 'chi'.\n",
                   props={SVN_PROP_MERGE_INFO : '/A/D/H/chi:8'}),
    })
  ...
  expected_disk_D = wc.State('', {
    ''        : Item(props={SVN_PROP_MERGE_INFO : '/A/D:6*'}),
    'H'       : Item(props={SVN_PROP_MERGE_INFO : '/A/D/H:6*,8*'}),
    'H/chi'   : Item("This is the file 'chi'.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/D/H/chi:6,8'}),
    'H/omega' : Item("New content",
                     props={SVN_PROP_MERGE_INFO : '/A/D/H/omega:6,8'}),
    'H/psi'   : Item("This is the file 'psi'.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/D/H/psi:6,8'}),
    'G'       : Item(props={SVN_PROP_MERGE_INFO : '/A/D/G:6*'}),
    'G/pi'    : Item("This is the file 'pi'.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/D/G/pi:6'}),
    'G/rho'   : Item("New content",
                     props={SVN_PROP_MERGE_INFO : '/A/D/G/rho:6'}),
    'G/tau'   : Item("This is the file 'tau'.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/D/G/tau:6'}),
    'gamma'   : Item("This is the file 'gamma'.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/D/gamma:6'}),
    })
  ...
  expected_output = wc.State(short_D_COPY_path, {
    'H/psi' : Item(status='U ')})
  expected_disk_D.tweak('', props={SVN_PROP_MERGE_INFO : '/A/D:5-6*'})
  expected_disk_D.tweak('G', props={SVN_PROP_MERGE_INFO : '/A/D/G:5-6*'})
  expected_disk_D.tweak('G/pi',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/pi:5-6'})
  expected_disk_D.tweak('G/rho',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/rho:5-6'})
  expected_disk_D.tweak('G/tau',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/tau:5-6'})
  expected_disk_D.tweak('H', props={SVN_PROP_MERGE_INFO : '/A/D/H:5-6*,8*'})
  expected_disk_D.tweak('gamma',
                        props={SVN_PROP_MERGE_INFO : '/A/D/gamma:5-6'})
  expected_disk_D.tweak('H/chi',
                        props={SVN_PROP_MERGE_INFO :'/A/D/H/chi:5-6,8'})
  expected_disk_D.tweak('H/psi', contents="New content",
                        props={SVN_PROP_MERGE_INFO :'/A/D/H/psi:5-6,8'})
  expected_disk_D.tweak('H/omega',
                        props={SVN_PROP_MERGE_INFO :'/A/D/H/omega:5-6,8'})
  ...
  expected_disk = wc.State('', {
    ...
    'D/G'       : Item(props={SVN_PROP_MERGE_INFO : '/A/D/G:5-8*'}),
    'D/G/pi'    : Item("This is the file 'pi'.\n",
                       props={SVN_PROP_MERGE_INFO : '/A/D/G/pi:5-8'}),
    'D/G/rho'   : Item("New content",
                       props={SVN_PROP_MERGE_INFO : '/A/D/G/rho:5-8'}),
    'D/G/tau'   : Item("This is the file 'tau'.\n",
                       props={SVN_PROP_MERGE_INFO : '/A/D/G/tau:5-8'}),
    'D/gamma'   : Item("This is the file 'gamma'.\n",
  ...
  wc_disk.tweak("A_COPY/D/H",
                props={SVN_PROP_MERGE_INFO : '/A/D/H:5-8*'})
  ...
  expected_disk_D.tweak('', props={SVN_PROP_MERGE_INFO : '/A/D:5-8*,10*',
                                   "prop:name" : "propval"})
  expected_disk_D.tweak('G',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G:5-8*,10*'})
  expected_disk_D.tweak('G/pi',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/pi:5-8,10'})
  expected_disk_D.tweak('G/rho',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/rho:5-8,10'})
  expected_disk_D.tweak('G/tau',
                        props={SVN_PROP_MERGE_INFO : '/A/D/G/tau:5-8,10'})
  expected_disk_D.tweak('H', props={SVN_PROP_MERGE_INFO : '/A/D/H:5-8,10'})
  expected_disk_D.tweak('gamma',
                        props={SVN_PROP_MERGE_INFO : '/A/D/gamma:5-8,10'})
...
def empty_mergeinfo(sbox):
  ...
  expected_disk = wc.State('', {
    ''          : Item(props={SVN_PROP_MERGE_INFO : '/A:3-4'}),
    'B'         : Item(),
    'mu'        : Item("This is the file 'mu'.\n"),
    'B/E'       : Item(),
    'B/E/alpha' : Item("This is the file 'alpha'.\n"),
...
def prop_add_to_child_with_mergeinfo(sbox):
  ...
  expected_disk = wc.State('', {
    ''        : Item(props={SVN_PROP_MERGE_INFO : '/A/B:7'}),
    'E'       : Item(),
    'E/alpha' : Item("This is the file 'alpha'.\n"),
    'E/beta'  : Item(contents="New content",
                     props={SVN_PROP_MERGE_INFO : '/A/B/E/beta:5,7',
                            'prop:name' : 'propval'}),
    'F'       : Item(),
    'lambda'  : Item("This is the file 'lambda'.\n")
    })
...
def avoid_reflected_revs(sbox):
  ...
  expected_disk = wc.State('', {
    ''         : Item(props={SVN_PROP_MERGE_INFO : '/A:5'}),
  ...
  expected_disk.tweak('', props={SVN_PROP_MERGE_INFO : '/A:3,5'})
  expected_disk.add({
...
def merge_to_out_of_date_target(sbox):
  ...
  expected_disk = wc.State('', {
    ''      : Item(props={SVN_PROP_MERGE_INFO : '/A/D/H:3'}),
    'psi'   : Item("New content"),
    'omega' : Item("This is the file 'omega'.\n"),
    'chi'   : Item("This is the file 'chi'.\n"),
    })
  ...
  expected_disk = wc.State('', {
    ''      : Item(props={SVN_PROP_MERGE_INFO : '/A/D/H:6'}),
    'psi'   : Item("This is the file 'psi'.\n"),
    'omega' : Item("New content"),
    'chi'   : Item("This is the file 'chi'.\n"),
    })
...
def merge_with_depth_files(sbox):
  ...
  expected_disk = wc.State('', {
    ...
    'mu'        : Item("this is file 'mu' modified.\n",
                       props={SVN_PROP_MERGE_INFO : '/A/mu:2-3'}),
    'B/E'       : Item(),
    'B/E/alpha' : Item("This is the file 'alpha'.\n"),
    'B/E/beta'  : Item("This is the file 'beta'.\n"),
    'B/lambda'  : Item("This is the file 'lambda'.\n"),
...
def no_mergeinfo_from_no_op_merge(sbox):
  ...
  svntest.actions.run_and_verify_svn(None,
                                     expected_merge_output([[3,4]], None),
                                     [], 'merge', '-r2:4',
                                     sbox.repo_url + '/A/B/E/beta',
                                     short_beta_COPY_path)
  ...
  short_tau_COPY_path = shorten_path_kludge(tau_COPY_path)
  svntest.actions.run_and_verify_svn(None,
                                     expected_merge_output([[5,6]], None),
                                     [], 'merge', '-r4:6',
                                     sbox.repo_url + '/A/D/G',
                                     short_G_COPY_path)
  os.chdir(saved_cwd)
  svntest.actions.run_and_verify_svn(None, ["/A/D/G:4\n"], [],
                                     'propget', SVN_PROP_MERGE_INFO,
                                     G_COPY_path)
  ...
  svntest.actions.run_and_verify_svn(None,
                                     expected_merge_output([[2,7]], None),
                                     [], 'merge',
                                     sbox.repo_url + '/A/C',
                                     short_C_COPY_path)
  os.chdir(saved_cwd)
  ...
  expected_disk = wc.State('', {
    ...
    'H'       : Item(props={'prop:name' : 'propval',
                            SVN_PROP_MERGE_INFO : '/A/D/H:6-9*'}),
    'H/chi'   : Item("This is the file 'chi'.\n"),
    'H/omega' : Item("This is the file 'omega'.\n"),
    'H/psi'   : Item("This is the file 'psi'.\n"),
    'G'       : Item(props={SVN_PROP_MERGE_INFO : '/A/D/G:4,6-9*'}),
    'G/pi'    : Item("This is the file 'pi'.\n"),
    'G/rho'   : Item("New content"),
    'G/tau'   : Item("This is the file 'tau'.\n"),
    'gamma'   : Item("This is the file 'gamma'.\n"),
  ...
  expected_disk = wc.State('', {
    ''        : Item(props={SVN_PROP_MERGE_INFO : '/A/D:4-9'}),
    'H'       : Item(props={'prop:name' : 'propval',
                            SVN_PROP_MERGE_INFO : '/A/D/H:4-8,9*'}),
    'H/chi'   : Item("This is the file 'chi'.\n"),
    'H/omega' : Item("New content"),
    'H/psi'   : Item("This is the file 'psi'.\n"),
    'G'       : Item(props={SVN_PROP_MERGE_INFO : '/A/D/G:4-8,9*'}),
    'G/pi'    : Item("This is the file 'pi'.\n"),
    'G/rho'   : Item("New content"),
    'G/tau'   : Item("This is the file 'tau'.\n"),
    'gamma'   : Item("This is the file 'gamma'.\n"),
...
def merge_to_sparse_directories(sbox):
  ...
  expected_disk = wc.State('', {
    ''          : Item(props={SVN_PROP_MERGE_INFO : '/A:5-9',
                              "prop:name" : "propval"}),
    'B'         : Item(props={SVN_PROP_MERGE_INFO : '/A/B:5-9*'}),
    'mu'        : Item("New content"),
    'C'         : Item(props={SVN_PROP_MERGE_INFO : '/A/C:5-9*'}),
    'D'         : Item(props={SVN_PROP_MERGE_INFO : '/A/D:5-9*',
                              "prop:name" : "propval"}),
    })
  ...
  expected_disk = wc.State('', {
    ''          : Item(props={SVN_PROP_MERGE_INFO : '/A:5-9*',
                              "prop:name" : "propval"}),
    'mu'        : Item("New content",
                       props={SVN_PROP_MERGE_INFO : '/A/mu:5-9'}),
    })
...
def mergeinfo_recording_in_skipped_merge(sbox):
  ...
  expected_status = wc.State(short_A_COPY, {
    ...
    'B'        : Item(status=' M', wc_rev=2),
    'B/lambda' : Item(status=' M', wc_rev=2),
    'B/F'      : Item(status=' M', wc_rev=2),
  ...
  expected_disk = wc.State('', {
    ''         : Item(props={SVN_PROP_MERGE_INFO : '/A:2-4'}),
    'mu'       : Item("This is the file 'mu' modified.\n"),
    'C'        : Item(),
    'D'        : Item(),
    'B'        : Item(props={SVN_PROP_MERGE_INFO : '/A/B:2-4*'}),
...
def propchange_of_subdir_raises_conflict(sbox):
  ...
  expected_disk = wc.State('', {
    ...
    'lambda'  : Item(contents="This is the file 'lambda' modified.\n",
                     props={SVN_PROP_MERGE_INFO : '/A/B/lambda:2-3'}),
    'F'       : Item(),
    'E'       : Item(),
...
def reverse_merge_prop_add_on_child(sbox):
  ...
  expected_disk = wc.State('', {
    ''    : Item(props={SVN_PROP_MERGE_INFO : '/A/D/G:3',
                        'prop:name' : 'propval'}),
    'pi'  : Item("This is the file 'pi'.\n"),
    'rho' : Item("This is the file 'rho'.\n"),
    'tau' : Item("This is the file 'tau'.\n"),
...
def basic_reintegrate(sbox):
  ...
  k_expected_disk = wc.State('', {
    ''          : Item(props={SVN_PROP_MERGE_INFO : '/A:2-7'}),
    'B'         : Item(),
    'B/lambda'  : Item("This is the file 'lambda'.\n"),
    'B/E'       : Item(),
    'B/E/alpha' : Item("This is the file 'alpha'.\n"),
  ...
  svntest.actions.run_and_verify_merge(short_A_COPY_path, None, None,
                                       ...
                                       None, True)
  os.chdir(saved_cwd)
  expected_disk.tweak('A_COPY', props={SVN_PROP_MERGE_INFO: '/A:2-7'})
  ...
  k_expected_disk.tweak('', props={SVN_PROP_MERGE_INFO : '/A_COPY:2-9'})
  k_expected_disk.add({
    'D/G/tauprime' : Item(props={SVN_PROP_MERGE_INFO: '/A/D/G/tau:2-7'},
                          contents="This is the file 'tau'.\n")
    })
  expected_skip = wc.State(short_A_path, {})
  saved_cwd = os.getcwd()
...
def merge_non_reflective_changes_from_reflective_rev(sbox):
  ...
  #Add A/C/tfile1.txt, A/C/tdir1 and commit, results in r5.
  #Delete A/C/tfile0.txt, A/C/tdir0 and commit, results in r6.
  #Add A/FB1/bfile1.txt, A/FB1/bdir1 and commit, results in r7.
  #Add A/C/tfile2.txt, A/C/tdir2 and commit, results in r8.
  #Add A/FB2/bfile2.txt, A/FB2/bdir2 and commit, results in r9.
  #Add A/C/tfile3.txt, A/C/tdir3 and commit, results in r10.
  ...
  #Add A/C/tfile0.txt and A/C/tdir0 and commit at r16.
  #Merge r3:16 from A/FB1 to A/C. Here r11,r12, r13 are reflective of '/A/C'.
  ...
  A_C_tdir0_path = os.path.join(A_C_path, 'tdir0')
  A_C_adhoc_dir_path = os.path.join(A_C_path, 'adhocdir')
  A_C_tdir1_path = os.path.join(A_C_path, 'tdir1')
  A_C_tdir2_path = os.path.join(A_C_path, 'tdir2')
  A_C_tdir3_path = os.path.join(A_C_path, 'tdir3')
  ...
  A_FB1_bdir1_path = os.path.join(A_FB1_path, 'bdir1')
  A_FB1_bdir3_path = os.path.join(A_FB1_path, 'bdir3')
  A_FB1_adhoc_dir_path = os.path.join(A_FB1_path, 'adhocdir')
  A_FB2_path = os.path.join(wc_dir, 'A', 'FB2')
  A_FB2_bfile2_path = os.path.join(A_FB2_path, 'bfile2.txt')
  A_FB2_bdir2_path = os.path.join(A_FB2_path, 'bdir2')
  ...
  svntest.main.file_write(A_C_tfile1_path, "This is the tfile1.\n")
  svntest.main.run_svn(None, 'add', A_C_tfile1_path)
  svntest.main.run_svn(None, 'mkdir', A_C_tdir1_path)
  expected_output = wc.State(A_C_path, {
    'tdir1'         : Item(verb='Adding'),
    'tfile1.txt'    : Item(verb='Adding'),
    })
  expected_status = wc.State(A_C_path, {
    ''        : Item(status='  ', wc_rev=4),
    'adhocdir'     : Item(status='  ', wc_rev=4),
    'tdir0'        : Item(status='  ', wc_rev=4),
  ...
  expected_output = wc.State(A_C_path, {
    'tdir0'         : Item(verb='Deleting'),
    'tfile0.txt'    : Item(verb='Deleting'),
    })
  expected_status = wc.State(A_C_path, {
    ''             : Item(status='  ', wc_rev=5),
    'adhocdir'     : Item(status='  ', wc_rev=5),
  ...
  svntest.main.run_svn(None, 'mkdir', A_FB1_bdir1_path)
  expected_output = wc.State(A_FB1_path, {
    'bfile1.txt'    : Item(verb='Adding'),
    'bdir1'         : Item(verb='Adding'),
    })
  expected_status = wc.State(A_FB1_path, {
    ''             : Item(status='  ', wc_rev=6),
    'adhocdir'     : Item(status='  ', wc_rev=6),
    'tdir0'        : Item(status='  ', wc_rev=6),
  ...
  svntest.main.run_svn(None, 'mkdir', A_C_tdir2_path)
  expected_output = wc.State(A_C_path, {
    'tfile2.txt'    : Item(verb='Adding'),
    'tdir2'         : Item(verb='Adding'),
    })
  expected_status = wc.State(A_C_path, {
    ''             : Item(status='  ', wc_rev=7),
    'adhoc.txt'    : Item(status='  ', wc_rev=7),
    'tfile1.txt'   : Item(status='  ', wc_rev=7),
    'tdir1'        : Item(status='  ', wc_rev=7),
    'adhocdir'     : Item(status='  ', wc_rev=7),
  ...
  svntest.main.run_svn(None, 'mkdir', A_FB2_bdir2_path)
  expected_output = wc.State(A_FB2_path, {
    'bfile2.txt'    : Item(verb='Adding'),
    'bdir2'         : Item(verb='Adding'),
    })
  expected_status = wc.State(A_FB2_path, {
    ''             : Item(status='  ', wc_rev=8),
    'adhocdir'     : Item(status='  ', wc_rev=8),
    'tdir0'        : Item(status='  ', wc_rev=8),
  ...
  svntest.main.run_svn(None, 'mkdir', A_C_tdir3_path)
  expected_output = wc.State(A_C_path, {
    'tfile3.txt'    : Item(verb='Adding'),
    'tdir3'         : Item(verb='Adding'),
    })
  expected_status = wc.State(A_C_path, {
    ''             : Item(status='  ', wc_rev=9),
    'adhoc.txt'    : Item(status='  ', wc_rev=9),
    'adhocdir'     : Item(status='  ', wc_rev=9),
    'tfile1.txt'   : Item(status='  ', wc_rev=9),
    'tdir1'        : Item(status='  ', wc_rev=9),
    'tfile2.txt'   : Item(status='  ', wc_rev=9),
    'tdir2'        : Item(status='  ', wc_rev=9),
  ...
  expected_status = wc.State(short_A_FB1, {
    ...
    'tdir0'        : Item(status='  ', wc_rev=10),
    'adhocdir'     : Item(status='  ', wc_rev=10),
    'bdir1'        : Item(status='  ', wc_rev=10),
  ...
  expected_status = wc.State(short_A_FB2, {
    ...
    'adhocdir'     : Item(status='  ', wc_rev=11),
    'bdir2'        : Item(status='  ', wc_rev=11),
    'tdir0'        : Item(status='D ', wc_rev=11),
  ...
  expected_status = wc.State(short_A_FB1, {
    ...
    'bdir1'        : Item(status='  ', wc_rev=12),
    'adhoc.txt'    : Item(status='  ', wc_rev=12),
    'adhocdir'     : Item(status='  ', wc_rev=12),
    'tfile0.txt'   : Item(status='D ', wc_rev=12),
    'tdir0'        : Item(status='D ', wc_rev=12),
    'tfile1.txt'   : Item(status='A ', wc_rev='-', copied='+'),
    'tdir1'        : Item(status='A ', wc_rev='-', copied='+'),
  ...
  svntest.main.run_svn(None, 'rm', A_FB1_adhoc_dir_path)

  expected_output = wc.State(A_FB1_path, {
    ''              : Item(verb='Sending'),
    'adhocdir'      : Item(verb='Deleting'),
  ...
  expected_status = wc.State(A_FB1_path, {
    ...
    'bdir2'        : Item(status='  ', wc_rev=13),
    'tfile1.txt'   : Item(status='  ', wc_rev=13),
    'tdir1'        : Item(status='  ', wc_rev=13),
    'bfile1.txt'   : Item(status='  ', wc_rev=12),
    'bdir1'        : Item(status='  ', wc_rev=12),
    'tfile3.txt'   : Item(status='  ', wc_rev=12),
    'tdir3'        : Item(status='  ', wc_rev=12),
  ...
  svntest.main.run_svn(None, 'mkdir', A_FB1_bdir3_path)
  expected_output = wc.State(A_FB1_path, {
    'bfile3.txt'    : Item(verb='Adding'),
    'bdir3'         : Item(verb='Adding'),
    })
  expected_status = wc.State(A_FB1_path, {
    ''             : Item(status='  ', wc_rev=13),
    'tfile1.txt'   : Item(status='  ', wc_rev=13),
    ...
    'tdir3'        : Item(status='  ', wc_rev=13),
    'bfile1.txt'   : Item(status='  ', wc_rev=13),
    'bdir1'        : Item(status='  ', wc_rev=13),
    'bfile2.txt'   : Item(status='  ', wc_rev=13),
    'bdir2'        : Item(status='  ', wc_rev=13),
  ...
  expected_status = wc.State(A_C_path, {
    ...
    'adhoc.txt'    : Item(status='  ', wc_rev=15),
    'adhocdir'     : Item(status='  ', wc_rev=15),
    'tfile0.txt'   : Item(status='  ', wc_rev=16),
    'tdir0'        : Item(status='  ', wc_rev=16),
  ...
  expected_status = wc.State(short_A_C, {
    ...
    'adhoc.txt'    : Item(status='D ', wc_rev=16),
    'adhocdir'     : Item(status='D ', wc_rev=16),
    'tfile0.txt'   : Item(status='  ', wc_rev=16),
    'tdir0'        : Item(status='  ', wc_rev=16),
    'tfile1.txt'   : Item(status='  ', wc_rev=16),
    'tdir1'        : Item(status='  ', wc_rev=16),
...
def merge_non_reflective_with_conflict(sbox):
  ...
  # Modify alpha in feature branch at r4
  svntest.main.file_substitute(alpha_fb_path, "line3 ", "fbline3 ")
  expected_output = wc.State(wc_dir, {
    'A/B/E_COPY/alpha' : Item(verb='Sending')
    })
  expected_status = svntest.actions.get_virginal_state(wc_dir, 3)
  ...
  inject_conflict_into_expected_state('alpha', expected_disk,
                                      expected_status, "fbline5 \n",
                                      "tline5 \n", 7)

  alpha_conflict_support_files = ["alpha\.working",
  ...
  expected_status = svntest.actions.get_virginal_state(wc_dir, 8)
  expected_status.add({
    'A/B/E/alpha'          : Item(status='  ', wc_rev=8),
    'A/B/E_COPY/alpha'     : Item(status='  ', wc_rev=9),
    'A/B/E_COPY'           : Item(status='  ', wc_rev=9),
    'A/B/E_COPY/beta'      : Item(status='  ', wc_rev=8),
    })
  svntest.actions.run_and_verify_commit(wc_dir, expected_output,
                                        expected_status, None, wc_dir)
  ...
  alpha_conflict_support_files = ["alpha\.working",
                                  "alpha\.merge-right\.r8",
                                  "alpha\.merge-left\.r2"]

  expected_error = "conflicts were produced while merging r2:8"
  #This merge will give raise to a conflict while merging r3:8
  #equivalent of a conflict that we have resolved in feature branch
  #As we get a conflict merge will halt at range 3:8 after recording it.
...
def merge_non_reflective_with_complex_conflict(sbox):
  ...
  ## feature branch in which the second merge gives rise to a conflict.
  ## Once the conflict is resolved we do the third merge. When all these
  ## 3 merges are done successfully and committed at rREFLECTIVE_REV.
  ## At the end we merge the feature branch to
  ...
  # Generate the new contents for alpha file with 30 lines.
  file_content = ""
  for n in range(1, 31):
    file_content = file_content + "This is line" + `n` + ".\n"

  # We'll consider A/B/E as the trunk
  # Modify alpha contents in trunk ie., r2
  svntest.main.file_write(alpha_path, file_content)
  expected_output = wc.State(wc_dir, {
    'A/B/E/alpha' : Item(verb='Sending'),
    })
  ...
  # Modify alpha in trunk at r4
  svntest.main.file_substitute(alpha_path, "line28.", "TLINE28.")
  expected_status = svntest.actions.get_virginal_state(wc_dir, 3)
  expected_status.add({
    'A/B/E_COPY/alpha'     : Item(status='  ', wc_rev=3),
    'A/B/E_COPY'           : Item(status='  ', wc_rev=3),
    'A/B/E_COPY/beta'      : Item(status='  ', wc_rev=3),
    })
  ...
  expected_status.tweak('A/B/lambda', wc_rev=5)
  expected_output = wc.State(wc_dir, {
    'A/B/lambda' : Item(verb='Sending')
    })
  svntest.actions.run_and_verify_commit(wc_dir, expected_output,
  ...
  expected_status.tweak('A/B/lambda', wc_rev=8)
  expected_output = wc.State(wc_dir, {
    'A/B/lambda' : Item(verb='Sending')
    })
  svntest.actions.run_and_verify_commit(wc_dir, expected_output,
  ...
  expected_status.tweak('A/B/E/alpha', wc_rev=9)
  expected_output = wc.State(wc_dir, {
    'A/B/E/alpha' : Item(verb='Sending')
    })
  svntest.actions.run_and_verify_commit(wc_dir, expected_output,
  ...
  expected_status = svntest.actions.get_virginal_state(wc_dir, 9)
  expected_status.add({
    'A/B/E/alpha'          : Item(status='  ', wc_rev=9),
    'A/B/E_COPY/alpha'     : Item(status='  ', wc_rev=10),
    'A/B/E_COPY'           : Item(status='  ', wc_rev=10),
  ...
  expected_status.tweak('A/B/E_COPY/alpha', wc_rev=11)
  expected_output = wc.State(wc_dir, {
    'A/B/E_COPY/alpha' : Item(verb='Sending')
    })
  svntest.actions.run_and_verify_commit(wc_dir, expected_output,
