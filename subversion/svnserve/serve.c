                                  ...
                                  svn_boolean_t ignore_ancestry)
{
  ...
  SVN_CMD_ERR(svn_repos_begin_report(&report_baton, rev, b->user, b->repos,
                                     ...
                                     editor, edit_baton, authz_check_access_cb,
                                     b, pool));
                           ...
                           apr_array_header_t *params, void *baton)
{
  ...
  SVN_ERR (svn_ra_svn_parse_tuple(params, pool, "rcrb", &rev, &base_path,
  ...
  SVN_CMD_ERR (svn_repos_replay2(root, base_path, low_water_mark,
