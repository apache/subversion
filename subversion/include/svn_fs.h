 ...
 * earlier than 1.8.
 *
 * @note There is no @c SVN_FS_CONFIG_PRE_1_7_COMPATIBLE option, since
 * Subversion 1.7 did not bump the repository or filesystem formats;
 * it always uses the same formats as Subversion 1.6.
 *
 * @since New in 1.8.
 */
