...
#define SVN_PROP_EXECUTABLE_VALUE SVN_UTF8_ASTERISK_STR

/** Set to TRUE ('*') if we want a file to be set to read-only when
 * not locked.  FALSE is indicated by deleting the property. */
#define SVN_PROP_NEEDS_LOCK  SVN_PROP_PREFIX \
        "\x6e\x65\x65\x64\x73\x2d\x6c\x6f\x63\x6b"
        /* "needs-lock" */

/** The value to force the needs-lock property to when set */
#define SVN_PROP_NEEDS_LOCK_VALUE SVN_UTF8_ASTERISK_STR
...
#define SVN_PROP_SPECIAL_VALUE SVN_UTF8_ASTERISK_STR
...
#define SVN_PROP_ENTRY_LOCK_TOKEN SVN_PROP_ENTRY_PREFIX \
 ...
 */
#define SVN_PROP_REVISION_AUTOVERSIONED  SVN_PROP_PREFIX \
        "\x61\x75\x74\x6f\x76\x65\x72\x73\x69\x6f\x6e\x65\x64"
        /* "autoversioned" */
